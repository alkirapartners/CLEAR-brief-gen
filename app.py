...
def main() -> None:
    ...
    st.markdown(
        ...
        f'font-size:14px;'
        f'font-weight:600;'
        f'border:1.5px solid rgba(255,255,255,0.6);'
        f'border-radius:8px;'
        f'text-decoration:none;'
        f'letter-spacing:0.01em;'
        f'transition:background 0.15s;'
        f'" onmouseover="this.style.background=\'rgba(255,255,255,0.25)\'" '
        f'onmouseout="this.style.background=\'rgba(255,255,255,0.15)\'">'
        f'Score Your Account List &#8594;'
        f'</a>'
        f'</div>'
        f'</div>',
        unsafe_allow_html=True,
